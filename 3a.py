...
p_tsne = TSNE(n_components=2, perplexity=34, n_iter=500).fit_transform(train_x)
plt.scatter(p_tsne[idxs_0, 0], p_tsne[idxs_0, 1], c='b', edgecolors='k', label='M')
plt.scatter(p_tsne[idxs_1, 0], p_tsne[idxs_1, 1], c='y', edgecolors='k', label='B')
plt.legend()
plt.show()
