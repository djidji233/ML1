...
all_data = np.loadtxt(filename, delimiter=',', converters={7: lambda s: 0.0, 9: lambda s: 0.0}, skiprows=1, usecols=np.arange(2,10))
...
# Opet, kako radimo na veoma malom setu podataka ukljucivanjem mesanja dobijamo razlicite rezultate,
# ali vidimo da je graf veoma slican cak i kada ukljucimo ostale feature. K je ponovo najbolje izmedju 3 i 6.
# Neki zakljucak bi bio da dodavanjem jos feature-a ne dobijamo bolje rezultate.